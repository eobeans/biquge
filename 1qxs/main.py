...
class downloader(object):
    def __init__(self):
        ...
        self.names = []  # 存放章节名
        self.urls = ['https://www.1qxs.com/xs/64130/190/3.html', 'https://www.1qxs.com/xs/64130/194/3.html',
                     'https://www.1qxs.com/xs/64130/259/7.html', 'https://www.1qxs.com/xs/64130/265/3.html']  # 存放章节链接
        self.nums = 0  # 章节数
        self.fails = []
...
if __name__ == '__main__':
    ...
    # dl.get_download_url()
    my_nums = len(dl.urls)
    for i in range(my_nums):
        dl.writer(dl.urls[i], '这太子不做也罢(补).txt', dl.get_contents(dl.urls[i]))
    print('下载完成!')
    print('下载失败链接')
    print(dl.fails)
